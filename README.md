...
- 📈 Working with SQL, Excel, Power BI and Data Visualization
...
### 🛒 Fake Store E-Commerce Website

- Developed a full-stack e-commerce application
- Frontend: React
- Backend: Django / APIs
- Database: MongoDB
- Features: Product listing, authentication and API integration


### 📊 Nifty 50 Stock Analysis & Prediction

- Analysed historical stock market data
- Applied data preprocessing and visualization techniques
- Used machine learning/deep learning approaches for prediction


### 🏥 Health Life Risk Assessment System

- Developed a health assessment web application
